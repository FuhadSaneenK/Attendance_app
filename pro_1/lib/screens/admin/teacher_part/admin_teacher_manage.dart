...
import 'package:pro_1/screens/admin/teacher_part/addteacher.dart';
import 'package:pro_1/screens/admin/teacher_part/viewteacher.dart';
...
class _TeacherManagementPageState extends State<TeacherManagementPage> {
  ...
  bool _isManageSubjectsSectionVisible = false;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                onPressed: () {
                  setState(() {
                    ...
                    if (_isViewTeachersSectionVisible) {
                      ...
                      _isManageSubjectsSectionVisible = false;
                    }
                  });
                },
              ),
              ...
              // Manage Subjects Button - Modified to use the same style as other buttons
              _buildSectionButton(
                title: 'Manage Semester Subjects',
                isExpanded: _isManageSubjectsSectionVisible,
                onPressed: () {
                  setState(() {
                    _isManageSubjectsSectionVisible = !_isManageSubjectsSectionVisible;
                    if (_isManageSubjectsSectionVisible) {
                      _isViewTeachersSectionVisible = false;
                      _isAddTeachersSectionVisible = false;
                      
                      // Navigate to the subjects management page
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ManageSemesterSubjects(),
                        ),
                      );
                    }
                  });
...
//               // Manage Subjects Button - This button will navigate to a new page
//               Container(
//                 width: double.infinity,
//                 margin: EdgeInsets.only(bottom: 16),
//                 child: ElevatedButton(
