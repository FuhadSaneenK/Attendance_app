...
class _MarkAttendancePageState extends State<MarkAttendancePage> {
  ...
  // New function to load subjects from timetable for the selected semester/class
  Future<void> _loadSubjectsForSemester(String semester) async {
    setState(() => isLoadingSubjects = true);
    try {
      // Extract semester number from the class name (assuming format like "Class 10A" or similar)
